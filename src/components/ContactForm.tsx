  ...
  const formContent = (
    ...
    >
      <div className="space-y-6">
        {isHero && (
          <div className="mb-2">
            <h3 className="text-3xl md:text-4xl font-heading font-bold text-foreground">Arrende com facilidade e total confiança</h3>
            <p className="text-sm md:text-base mt-1">
              <span className="inline-block bg-[#C2855E] text-white px-3 py-1 rounded-full shadow-md">
                Exclusivo para registos realizados nas próximas 24 horas.
              </span>
            </p>
          </div>
        )}
        ...
        >
          {isSubmitting ? "A enviar..." : "Quero arrendar imóveis"}
        </Button>
